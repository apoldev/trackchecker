...
func NewTrackCheckerAppAPI(spec *loads.Document) *TrackCheckerAppAPI {
	return &TrackCheckerAppAPI{
		...
		PostTrackHandler: PostTrackHandlerFunc(func(params PostTrackParams) middleware.Responder {
			return middleware.NotImplemented("operation PostTrack has not yet been implemented")
		}),
...
func (o *TrackCheckerAppAPI) Validate() error {
	...
	if o.PostTrackHandler == nil {
		unregistered = append(unregistered, "PostTrackHandler")
	}
...
func (o *TrackCheckerAppAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/track"] = NewPostTrack(o.context, o.PostTrackHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/track"] = NewGetResults(o.context, o.GetResultsHandler)
}
